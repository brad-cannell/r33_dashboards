...
api_token <- Sys.getenv("DETECT_TOOL_REDCAP_API_TOKEN") # Get saved REDCap API token
...
```{r}
# go_uth_app_name <- keyring::key_list("detect_tool_go_uth_api")[1,2]
# go_uth_api_token <-  keyring::key_get("detect_tool_go_uth_api", go_uth_app_name) # Get saved API token

go_uth_app_name <- "DetectToolLinks"
go_uth_api_token <- Sys.getenv("DETECT_TOOL_LINKS_TOKEN")
...
```{r}
definitions_link_hits <- go_uth_link_api("elder_abuse_definitions")
