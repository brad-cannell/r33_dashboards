...
answers_per_eligible_record <- map_dfr(free_text_fields, ~ perc_answer_based_on_availability(data, .x, free_text_branching_logic))

answers_per_record <- answers_per_record |> tibble::add_column(free_text_fields, .before = 1) |> setNames(c("Textbox Variable", "Answered N", "Answered %"))
answers_per_eligible_record <- answers_per_eligible_record |> tibble::add_column(free_text_fields, .before = 1) |> setNames(c("Textbox Variable", "Answered N", "Answered %"))
```
