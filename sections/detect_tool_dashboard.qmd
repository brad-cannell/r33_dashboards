...
# DT table for free-text ("textbox") variables. Defined here so the
# per-institution pages below can reuse it. The "All" page no longer displays a
# textbox table, but the institution pages still do.
